...
export function OnboardingMultiSelectField({ options, value, onChange }: Props) {
      ...
      {options.map((option, index) => {
        ...
        return (
          ...
          >
            ...
            <span className="text-sm leading-snug text-foreground sm:text-base">{option.label}</span>
          </motion.button>
        );
      })}
    </div>
