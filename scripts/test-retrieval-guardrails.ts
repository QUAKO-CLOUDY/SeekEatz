...
const CASES: GuardrailCase[] = [
    ...
    items: [
      {
        ...
        normalized_category: 'bowl',
        meal_type: 'all_day',
        macros: { calories: 620, protein: 28, carbs: 52, fat: 18 },
      },
    ],
  ...
  {
    name: 'healthy lunch discovery enforces minimum meal calories and excludes unhealthy items',
    query: 'healthy lunch near me',
    items: [
      {
        ...BASE_ITEM,
        id: 'healthy-lunch-low-cal-1',
        name: 'Grilled Chicken Salad',
        restaurant_name: 'Fresh Spot',
        normalized_category: 'salad',
        meal_type: 'lunch',
        item_type: 'meal',
        macros: { calories: 420, protein: 31, carbs: 24, fat: 16 },
      },
      {
        ...BASE_ITEM,
        id: 'healthy-lunch-good-1',
        name: 'Salmon Grain Bowl',
        restaurant_name: 'Fresh Spot',
        normalized_category: 'bowl',
        meal_type: 'lunch',
        item_type: 'meal',
        macros: { calories: 680, protein: 38, carbs: 52, fat: 24 },
      },
      {
        ...BASE_ITEM,
        id: 'healthy-lunch-wings-1',
        name: 'Crispy Wings Plate',
        restaurant_name: 'Wing House',
        normalized_category: 'entree',
        meal_type: 'lunch',
        item_type: 'meal',
        macros: { calories: 900, protein: 42, carbs: 35, fat: 58 },
      },
    ],
    expectedIds: ['healthy-lunch-good-1'],
    unexpectedIds: ['healthy-lunch-low-cal-1', 'healthy-lunch-wings-1'],
  },
  {
    name: 'explicit low calorie constraints bypass the minimum meal calorie floor',
    query: 'healthy lunch under 500 calories',
    items: [
      {
        ...BASE_ITEM,
        id: 'healthy-low-cal-allowed-1',
        name: 'Grilled Chicken Salad',
        restaurant_name: 'Fresh Spot',
        normalized_category: 'salad',
        meal_type: 'lunch',
    ...
    expectedIds: ['healthy-low-cal-allowed-1'],
    unexpectedIds: ['healthy-low-cal-over-1'],
  },
];
