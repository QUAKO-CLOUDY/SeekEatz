...
const TESTIMONIALS = [
    ...
    {
        quote: 'Finally an app that gets it — I eat out every day. This is the only thing that actually helps me stay on track.',
        name: 'Beta Tester',
        handle: '@earlyaccess',
        avatar: '🏋️',
        color: '#8b5cf6',
    ...
    {
        quote: 'The AI swaps are insane. It suggested a grilled chicken bowl instead of a burrito and saved me 400 calories at the same restaurant.',
        name: 'Beta Tester',
        handle: '@earlyaccess',
        avatar: '🔥',
        color: '#10b981',
